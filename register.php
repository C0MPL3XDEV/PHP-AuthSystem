...
if (isset($_POST["submit"])) {
    ...
    if (mysqli_num_rows($verify_query) != 0) {
        ...
        session_start();
        $insert_query = "INSERT INTO users (callsign, datebirth, username, email, password) VALUES ('$name', '$date', '$username', '$email', '$password')";
   ...
   <div class="container" data-bs-theme="dark">
       <form action="register.php" method="POST">
            ...
            <div class="input-group mb-3">
                ...
                <input type="date" class="form-control" placeholder="Date Of Birth" name="date" aria-label="Date" aria-describedby="basic-addon1">
            </div>
