...
<div class="container1" data-bs-theme="dark">
    <form action="login.php" method="POST">
        ...
        <div class="input-group mb-3">
            ...
            <input type="password" class="form-control" placeholder="Password"
                   name="username" aria-label="Password" aria-describedby="basic-addon1">
        </div>
        <button type="submit" class="btn btn-primary">Sign-In</button><span> Dont have an account? <a href="register.php">Sign-Up</a> </span>
    </form>
</div>
</body>
</html>